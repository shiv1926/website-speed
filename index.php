...
Cumulative Layout Shift (CLS)
	...
	<li><a href="avoid-an-excessive-dom-size.php">Avoid an excessive DOM size</a></li>
	<li>
		<h4>Hosting</h4>
		<ul>
			<li>https://catswhocode.com/best-web-hosting-for-developers/</li>
			<li>https://catswhocode.com : read for hosting, cheap hosting etc</li>
